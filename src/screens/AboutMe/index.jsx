import { View, Text, ImageBackground, Image, TouchableOpacity, Linking, ScrollView } from 'react-native';
...
export default function AboutMe() {
  return (
    ...
    <ImageBackground source={require('../../../assets/backgroundPlanetProfile.jpg')} style={styles.backgroundImage}>
